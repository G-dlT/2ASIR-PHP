...
// Consulta para obtener los datos de todos los profesores
...
if (mysqli_num_rows($resultado_profesores) > 0) {
    ...
    echo "<div class='alert alert-warning' role='alert'>No se encontraron profesores registrados.</div>";
}

echo "</div>";

// Cerrar conexión después de ejecutar todas las consultas
